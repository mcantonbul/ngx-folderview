...
class NgxFolderViewService {
    setSelectedFolder(id, htmlElement) {
        ...
        (_a = this.selectedFolderHTMLElement) === null || _a === void 0 ? void 0 : _a.classList.remove('selected');
    ...
    constructor(ngxFolderviewService, ngxFolderviewEventService) {
        ...
        this._createNewSubFolderHandler = (folder) => {
            ...
            if (!selectedFolderId) {
                ...
                const findedIndex = ((_a = folder.children) === null || _a === void 0 ? void 0 : _a.findIndex(s => s.id === selectedFolderId)) || -1;
                if (findedIndex < 0)
                    return;
